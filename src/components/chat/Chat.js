...
function Chat(props) {
    ...
    async function findContacts(){
        const response = await fetch('http://localhost:7038/api/Contacts/?user='+saveUser.userName);
    ...
    async function AddContact(){
        ...
        await fetch('http://localhost:7038/api/contacts/AddContact', init);
    }
    ...
    async function InviteContact(){
        ...
        const response=await fetch(`http://${server}/api/invitation/AddContact`, init);
